 ...
 */
public class PubObjectType implements DataObjectType<PubObject>{
	public static PubObjectType INSTANCE=new PubObjectType();
	private PubObjectType(){
	}
	@Override
	...
	@Override
	public PubObject readFrom(URLConnection connection,RegistryNode<String,Object> meta) throws Exception{
		return new PubObject(new HPBFDocument(connection.getInputStream()));
	}
}
