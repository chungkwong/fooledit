...
(map-mime-to-type "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" "cc.fooledit.editor.msoffice.excel.XlsObjectType")
(map-suffix-to-mime "xlsx" "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")
(map-mime-to-type "application/vnd.openxmlformats-officedocument.spreadsheetml.template" "cc.fooledit.editor.msoffice.excel.XlsObjectType")
...
(map-mime-to-type "application/vnd.ms-visio.drawing.main+xml" "cc.fooledit.editor.msoffice.visio.VsdxObjectType")
(map-suffix-to-mime "vsdx" "application/vnd.ms-visio.drawing.main+xml")
(map-mime-to-type "application/vnd.ms-visio.template.main+xml" "cc.fooledit.editor.msoffice.visio.VsdxObjectType")
(map-suffix-to-mime "vstx" "application/vnd.ms-visio.template.main+xml")
(map-mime-to-type "application/vnd.ms-visio.stencil.main+xml" "cc.fooledit.editor.msoffice.visio.VsdxObjectType")
(map-suffix-to-mime "vssx" "application/vnd.ms-visio.stencil.main+xml")
(map-mime-to-type "application/vnd.ms-visio.drawing.macroEnabled.main+xml" "cc.fooledit.editor.msoffice.visio.VsdxObjectType")
(map-suffix-to-mime "vsdm" "application/vnd.ms-visio.drawing.macroEnabled.main+xml")
(map-mime-to-type "application/vnd.ms-visio.template.macroEnabled.main+xml" "cc.fooledit.editor.msoffice.visio.VsdxObjectType")
(map-suffix-to-mime "vstm" "application/vnd.ms-visio.template.macroEnabled.main+xml")
(map-mime-to-type "application/vnd.ms-visio.stencil.macroEnabled.main+xml" "cc.fooledit.editor.msoffice.visio.VsdxObjectType")
