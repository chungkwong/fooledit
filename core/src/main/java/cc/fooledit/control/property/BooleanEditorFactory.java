...
public class BooleanEditorFactory implements PropertyEditorFactory<Boolean,CheckBox>{
	...
	@Override
	public Boolean getValue(CheckBox node){
		return node.isSelected();
	}
	@Override
	public void setValue(Boolean value,CheckBox node){
		node.setSelected(value);
	}
	@Override
	public void addPropertyChangeListener(ChangeListener<? super Boolean> listener,CheckBox node){
		node.selectedProperty().addListener(listener);
	}
	@Override
	public void removePropertyChangeListener(ChangeListener<? super Boolean> listener,CheckBox node){
