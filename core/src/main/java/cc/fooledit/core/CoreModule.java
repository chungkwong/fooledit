...
public class CoreModule{
	...
	public static RegistryNode<String,Command> COMMAND_REGISTRY;
	...
	public static void onInit(){
		...
		COMMAND_REGISTRY=(RegistryNode<String,Command>)REGISTRY.getOrCreateChild(COMMAND_REGISTRY_NAME);
