...
VARUABLE: 'ARGC'|'ARGIND'|'ARGV'|'BINMODE'|'CONVFMT'|'ENVIRON'|'ERRNO'|'FIELDWIDTHS'|'FILENAME'|'FNR'|'FPAT'|'FS'|'FUNCTAB'|'IGNORECASE'|'LINT'|'NF'|'NR'|'OFMT'|'OFS'|'ORS'|'PREC'|'PROCINFO'|'ROUNDMODE'|'RS'|'RT'|'RSTAT'|'RLENGTH'|'SUBSEP'|'SYMTAB'|'TEXTDOMAIN';
