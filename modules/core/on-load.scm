...
(let ((protocols (get-registry "core/provider/core/protocol")))
     (set-entry! protocols "archive" "editor.zip")
     (set-entry! protocols "compressed" "editor.zip"))
(let ((templates (get-registry "core/provider/core/template_type")))
     (set-entry! templates "text" "editor.text")
     (set-entry! templates "image" "editor.image"))
