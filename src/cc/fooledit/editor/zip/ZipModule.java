...
public class ZipModule{
	...
	public static void onInstall(){
		...
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("7z","application/x-7z-compressed");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("ar","application/x-archive");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("arj","application/x-arj");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("apk","application/vnd.android.package-archive");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("bz2","application/x-bzip2");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("cpio","application/x-cpio");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("deb","application/vnd.debian.binary-package");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("ear","application/x-java-archive");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("gz","application/x-gzip");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("jar","application/x-java-archive");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("pack","application/x-java-pack200");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("lz4","application/x-lz4");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("lzma","application/x-lzma");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("tar","application/x-tar");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("war","application/x-java-archive");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("xz","application/x-xz");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("zip","application/x-zip-compressed");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("Z","application/zlib");
		ContentTypeHelper.getSUFFIX_GUESSER().registerSuffix("zz","application/zlib");
