...
import cc.fooledit.editor.text.mode.swift.Activator;
...
public class Activator implements BundleActivator{
	...
	public void start(BundleContext bc) throws Exception{
		...
		StructuredTextEditor.INSTANCE.registerHighlighter(cc.fooledit.editor.text.mode.swift.Swift4Lexer.class,Activator.class.getResourceAsStream("tokens.json"),CONTENT_TYPE);
