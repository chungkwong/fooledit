...
public class Activator implements BundleActivator{
	...
	public void start(BundleContext bc) throws Exception{
		...
		StructuredTextEditor.INSTANCE.registerHighlighter(cc.fooledit.editor.text.mode.java.Java9Lexer.class,Activator.class.getResourceAsStream("token.json"),CONTENT_TYPE);
