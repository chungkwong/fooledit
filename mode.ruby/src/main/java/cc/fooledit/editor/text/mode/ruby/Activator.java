...
public class Activator implements BundleActivator{
	...
	public void start(BundleContext bc) throws Exception{
		...
		StructuredTextEditor.INSTANCE.registerHighlighter(cc.fooledit.editor.text.mode.ruby.CorundumLexer.class,Activator.class.getResourceAsStream("token.json"),CONTENT_TYPE);
